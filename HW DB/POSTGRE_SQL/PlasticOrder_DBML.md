...
Table dbo.departments as departments [note: 'Отделения выдачи Карт']{
  ...
  // добавлены новые поля из ДЗ КЛАДР
  City nvarchar [null, note: 'Наименование Города.(255)']
  Village nvarchar [null, note: 'Наименование населенного пункта.(255)']
  Street nvarchar [null, note: 'Наименование улицы.(255)']
  Build nvarchar [null, note: 'Номер дома.(255)']
  SCNAME varchar [null, note: 'Тип адресного объекта "улица".(10)']
  KLADR varchar [null, note: 'КЛАДР. Код адресного объекта "город".(13)']
  KLADR_STREET varchar [null, note: 'КЛАДР. Код адресного объекта "улица".(17)']
